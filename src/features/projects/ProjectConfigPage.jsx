/**
 * ======================================================================
 * FILE: src/features/projects/ProjectConfigPage.jsx (FULLY UPDATED)
 * PURPOSE: Project configuration form - aligned with projectConfig.model.js
 * UPDATES: Added conclusion field, fixed checkbox handling, proper validation
 * SOC 2 NOTES: Secure form handling, input validation, centralized icons
 * ======================================================================
 */
...
const FormCheckbox = ({ label, checked, onChange, description, name }) => {
    const handleClick = (e) => {
        ...
        // ✅ FIXED: Create proper event object
...
const ProjectConfigPage = () => {
    ...
    // ✅ SOC 2: Form state - ALIGNED WITH projectConfig.model.js
    const [configData, setConfigData] = useState({
        ...
        executiveSummary: '',
        testingNotes: '',
        conclusion: '', // ✅ NEW: Added conclusion field
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (
                ...
                // ✅ Load all fields from config response
                setConfigData((prev) => ({
                    ...prev,
                    // Basic Information
                    ...
                    reportingCriteria:
                        configResponse.data.reportingCriteria || '',
                    methodology: configResponse.data.methodology || '',
                    findings: configResponse.data.findings || '',
                    executiveSummary:
                        configResponse.data.executiveSummary || '',
                    testingNotes: configResponse.data.testingNotes || '',
                    conclusion: configResponse.data.conclusion || '', // ✅ Load conclusion
                    // Report Sections (Toggles) - use ?? to handle false values
                    tableOfContents:
                        configResponse.data.tableOfContents ?? true,
                    listOfFigures:
                        configResponse.data.listOfFigures ?? true,
                    listOfTables:
                        configResponse.data.listOfTables ?? true,
                    documentControl:
                        configResponse.data.documentControl ?? true,
                    ...
                    findingsSection:
                        configResponse.data.findingsSection ?? true,
                    conclusionSection:
                        configResponse.data.conclusionSection ?? true,
                    appendixSection:
                        configResponse.data.appendixSection ?? true,
                }));
                setIsEditMode(true);
            } else {
                // ✅ New config - use project data as defaults
                setConfigData((prev) => ({
                    ...prev,
    ...
    const validateForm = () => {
        ...
        if (!configData.projectName || !configData.projectName.trim()) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const cleanedData = {
                ...
                conclusion: (configData.conclusion || '').trim(), // ✅ Include conclusion
                // Report Sections (Toggles)
                tableOfContents: configData.tableOfContents,
                listOfFigures: configData.listOfFigures,
                listOfTables: configData.listOfTables,
                documentControl: configData.documentControl,
                disclaimer: configData.disclaimer,
                executiveSummarySection:
                    configData.executiveSummarySection,
                scopeSection: configData.scopeSection,
                reportingCriteriaSection:
                    configData.reportingCriteriaSection,
                methodologySection: configData.methodologySection,
                findingsSection: configData.findingsSection,
                conclusionSection: configData.conclusionSection,
                appendixSection: configData.appendixSection,
            };
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <FormInput
                            ...
                            onChange={handleChange}
                            placeholder="e.g., VAPT, Penetration Test"
