/**
 * ======================================================================
 * FILE: src/features/tester/TesterDashboardPage.jsx (COMPLETE - FIXED)
 * PURPOSE: Complete tester dashboard with GitHub-style heatmap & metrics
 * FIXES:
 * - Added missing testerApi import
...
import { getTesterDashboard } from '../../api/testerApi'; // ✅ FIXED: Added import
...
const TesterDashboardPage = () => {
    ...
    const fetchDashboard = async () => {
        try {
            ...
            // ✅ FIXED: Safe data extraction with defensive checks
    ...
    if (error) {
        return (
            <div
                className={`${theme} theme-${color} flex items-center justify-center min-h-screen`}
            >
                <div className="text-center max-w-md">
                    <AlertTriangleIcon className="w-16 h-16 text-red-600 dark:text-red-400 mx-auto mb-4" />
    ...
    // ✅ FIXED: Defensive data extraction
    const {
        tester = {},
        statistics = {},
